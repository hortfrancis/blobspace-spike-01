...
| --- | --- | --- | --- |
| 1 | Echo socket in Discord | Does `wss://` survive the proxy? | — |
...
Surprises, dead ends, anything the spec got wrong. Newest first. Empty until
step one tells us something.
